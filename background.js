...
/**
 * [NOT-57] Injected function to extract page metadata
 * This runs in the context of the webpage
 * 
...
function extractPageMetadata() {
  ...
  function extractGitHubMetadata() {
    ...
    try {
      ...
      // Use console.warn in page context
      console.warn('[NOT-57] Failed to extract GitHub metadata:', error);
    }
  ...
  function extractYouTubeMetadata() {
    ...
    try {
      ...
      console.warn('[NOT-57] Failed to extract YouTube metadata:', error);
    }
  ...
  function extractDefaultMetadata() {
    ...
    try {
      ...
      console.warn('[NOT-57] Failed to extract default metadata:', error);
    }
